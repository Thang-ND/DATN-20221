...
function HeroSection() {
  ...
  const AddPost = (post) => {
    ...
    setPagination({});
    setSubmit(false);
    //alert(`http://localhost:8080/api/devices/pagination?name=${post.name}&color=${post.color}&ram=${post.ram}&rom=${post.rom}&offset=0&pageSize=9`);
    axios.
  ...
  return (
    <div className='hero-container'>
      ...
      {/*<div className='text-field'>
        <label for="name">Please Enter Value</label>
